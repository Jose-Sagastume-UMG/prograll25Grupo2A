...
public class FormCompraAgregar extends javax.swing.JInternalFrame {
    ...
    private void cargarCategorias() {
        miumg.edu.gt.proyectotiendalafelicidad.igu.Formulario.Class.CategoriaC categoriaC
                = new miumg.edu.gt.proyectotiendalafelicidad.igu.Formulario.Class.CategoriaC();
    ...
    private void cargarProductosInicial() {
        if (ComboBoxCategoriaExistente.getItemCount() > 0) {
            String primeraCategoria = (String) ComboBoxCategoriaExistente.getItemAt(0);
            cargarProductosPorCategoria(primeraCategoria);
        }
    }
    ...
    private void configurarTabla() {
        String[] columnas = {"Categoría", "Cantidad", "Precio Unitario", "Subtotal", "Detalle"};
    ...
    private void actualizarTotal() {
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) {
            total = total.add(new BigDecimal(modelo.getValueAt(i, 3).toString()));
        }
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        boolean seleccionado = jCheckBox1.isSelected();
        txtNuevaCategoria.setEnabled(seleccionado);
        jTextField1.setEnabled(seleccionado);
        ComboBoxCategoriaExistente.setEnabled(!seleccionado);
    }//GEN-LAST:event_jCheckBox1ActionPerformed

    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (txtCantidad.getText().isEmpty() || txtPrecioUnitario.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Ingrese cantidad y precio unitario.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (jCheckBox1.isSelected()) {
            // Producto nuevo
            detalle = txtNombreProducto.getText();
            ...
            // Producto existente
            detalle = (String) ComboBoxProductosExistentes.getSelectedItem();
        }

        // Agregar fila a la tabla
        DefaultTableModel modelo = (DefaultTableModel) TablaVistaCamposAgregarCompra.getModel();
        modelo.addRow(new Object[]{categoria, cantidad, precio, subtotal, detalle});
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        var em = compraService.getEntityManager();
        ...
        try {
            ...
            for (int i = 0; i < modelo.getRowCount(); i++) {
                ...
                BigDecimal subtotal = new BigDecimal(modelo.getValueAt(i, 3).toString());
                String detalleTexto = modelo.getValueAt(i, 4).toString();

                var categoria = compraService.obtenerOCrearCategoria(em, nombreCategoria);
                Producto producto = compraService.obtenerOCrearProducto(em, detalleTexto, nombreCategoria, cantidad, categoria);
